...
- The current firmware (**v2.7.0**) has **no** provision secret — `POST /provision`
...
+------------------------------------------------------+
   fw 2.7.0 / proto 1        S/N: __________  QC:____
```
...
| `fw_version` | Flashed firmware version | `2.7.0` |
...
```
serial,build_date,operator,mac,probe_id,ap_ssid,fw_version,version,test_wifi_ssid,temperature_c,ice_c,ingest_ok,qc_result,notes
TP2607-001,2026-07-06,TJ,A4:CF:12:9A:3F:2C,Setpoint-9A3F2C,Setpoint-9A3F2C,2.7.0,Portable,bench-2g,23.4,0.1,yes,PASS,plug-and-play
TP2607-002,2026-07-06,TJ,A4:CF:12:7B:10:44,Setpoint-7B1044,Setpoint-7B1044,2.7.0,Fixed,bench-2g,22.9,-0.1,yes,PASS,plug-and-play
```
