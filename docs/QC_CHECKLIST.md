...
- Firmware: **v2.8.1**, protocol v1. Identity rules and pin map are defined in
...
- [ ] **7.1** Note on the serial log that this firmware ships **open
      ...
      not implemented in v2.8.1). The setup network itself is an **open** per-unit
