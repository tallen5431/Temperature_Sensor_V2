...
- Firmware: **v2.9.5**, protocol v1 — the **same image on both boards**, no build flag.
...
- [ ] **7.1** Note on the serial log that this firmware ships **open
      ...
      not implemented in v2.9.5). The setup network itself is an **open** per-unit
